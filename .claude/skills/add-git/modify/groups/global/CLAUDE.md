...
You can push and pull from GitHub repositories. Git is pre-configured with HTTPS credentials — just `git clone`, `git push`, etc. as normal. Your git identity is set automatically.

This only works in the main group container. Other groups do not have git credentials.
